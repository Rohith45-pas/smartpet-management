...
<%
    ...
    GroomingDAO groomingDAO = new GroomingDAO();
...
<head>
    ...
    <title>Pet Grooming - SmartPet</title>
...
<div class="container">
    ...
    <% if (groomingList.isEmpty()) { %>
        ...
        <div class="empty">
            ...
            <p>Add a grooming record for this pet.</p>
            ...
            <% for (Grooming grooming : groomingList) { %>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="edit-grooming.jsp?groomingId=<%= grooming.getGroomingId() %>&petId=<%= petId %>"
                           class="edit">
                            ✏️ Edit
                        </a>
                        ...
                        <a href="DeleteGroomingServlet?groomingId=<%= grooming.getGroomingId() %>&petId=<%= petId %>"
                           class="delete"
                           onclick="return confirm('Are you sure you want to delete this grooming record?');">
                            🗑️ Delete
                        </a>
