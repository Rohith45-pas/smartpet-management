...
<head>
    ...
    <title>Medicine Management - SmartPet</title>
...
<div class="container">
    ...
    <a href="add-medicine.jsp" class="add-button">
        ➕ Add Medicine
    </a>
    ...
    <% if (medicines.isEmpty()) { %>
        ...
        <div class="empty">
            ...
            <p>Add the first medicine to the system.</p>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="edit-medicine.jsp?medicineId=<%= medicine.getMedicineId() %>"
                       class="edit">
                        ✏️ Edit
                    </a>
                    ...
                    <a href="DeleteMedicineServlet?medicineId=<%= medicine.getMedicineId() %>"
                       class="delete"
